        ...
        <div class="py-6 relative w-full h-screen sm:w-7/12 md:w-6/12 lg:w-4/12 m-auto">
          ...
          <div class="bg-white rounded py-2 px-6 flex flex-col justify-center">
            <div class="mb-4">
              ...
              <form novalidate class="space-y-4 flex flex-col">
                ...
                <div class="flex justify-center">
                    <button type="button" class="w-52 text-white bg-[#B0D892] hover:bg-green-600 font-medium rounded-lg text-sm py-2.5 text-center">Iniciar Sesion</button>
                </div>
              </form>
            </div>

            <a href="/html/RecuperarContraseña.html" class="hover:text-blue-500 hover:underline text-center">¿Olvidaste tu contraseña?</a>
          </div>
          ...
          <div class="bg-white rounded  mt-2 pb-2 px-6 flex flex-col justify-center">
            ...
            <Span class="text-center">¿No tienes una cuenta? <a class="font-bold text-[#B0D892] hover:underline hover:text-green-500" href='login/registro'>Registrate aqui</a></Span>
          </div>
        </div>
